      ...
      <div className="flex-1 w-full flex flex-col items-center justify-center p-4 bg-[var(--surface-1)] py-12 relative overflow-hidden">
        ...
        >
          ...
          <div className="p-8 text-center">
            ...
            <h2 className="text-xl font-extrabold mb-3 text-[var(--text-primary)]">
              PIX não configurado
            </h2>
        ...
        <div className="mb-8 flex justify-center animate-fade-up">
          <div className="flex items-center gap-3 px-5 py-2.5 bg-white border border-[var(--surface-border)] rounded-full shadow-sm">
            ...
            <span className="text-[14px] font-bold text-[var(--text-primary)]">
              {config?.merchant_name || 'GeraPix Store'}
            </span>
          </div>
        </div>
          ...
          <div className="p-8">
            ...
            <form onSubmit={handleGenerate} className="space-y-8">
              <div className="space-y-2">
                <label htmlFor="amount" className="label-sm ml-1">
                  Valor da Cobrança
                </label>
                <div className="relative">
                  <span className="absolute left-5 top-1/2 -translate-y-1/2 text-[var(--text-tertiary)] font-bold text-lg">
                    R$
                  </span>
                  <input
                    id="amount"
