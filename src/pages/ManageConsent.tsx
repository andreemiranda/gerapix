...
export default function ManageConsent() {
  ...
  return (
    <LegalPage title="Gerenciar Consentimento" lastUpdated="04 de Maio de 2026">
      <p>
        Nesta página, você pode gerenciar suas preferências de privacidade e cookies para o GeraPix, em total conformidade com a 
      ...
      <div className="my-10 space-y-8">
        <div className="p-6 bg-[var(--surface-2)] rounded-2xl border border-[var(--surface-border)]">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h3 className="text-[15px] font-extrabold text-[var(--text-primary)]">Status Atual</h3>
          ...
          <p className="text-[13px] text-[var(--text-secondary)] leading-relaxed">
            Sua decisão é armazenada localmente no seu navegador e pode ser revogada a qualquer momento nesta página ou no rodapé do site.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="card p-6">
            ...
            <p className="text-[13px] text-[var(--text-secondary)] mb-6">
              Necessários para o funcionamento básico, autenticação administrativa e armazenamento de suas preferências de privacidade. 
              <strong> Não podem ser desativados.</strong>
            </p>
            <div className="text-[11px] font-bold text-[var(--color-success)] bg-[var(--color-success)]/10 px-3 py-1 rounded w-fit uppercase">Vigente</div>
          </div>
          ...
          <div className="card p-6">
            ...
            <p className="text-[13px] text-[var(--text-secondary)] mb-6">
              Utilizados para entender como os usuários interagem com o sistema, permitindo melhorias de interface e performance de forma anônima.
            </p>
            <div className="text-[11px] font-bold text-[var(--text-tertiary)] bg-[var(--surface-2)] px-3 py-1 rounded w-fit uppercase border border-[var(--surface-border)]">Opcional</div>
          </div>
        </div>
      ...
      <p>
        O tratamento de dados no GeraPix é limitado ao estritamente necessário para gerar as cobranças PIX solicitadas. Para detalhes completos sobre 
        quais dados coletamos e como os protegemos, visite nossa <a href="/politica-de-privacidade">Política de Privacidade</a>.
      </p>
    </LegalPage>
  );
}
