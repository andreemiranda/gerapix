    ...
    <div className="min-h-full w-full flex flex-col items-center py-8 px-4 overflow-y-auto custom-scrollbar">
      ...
      >
        <div className="pix-card overflow-hidden shadow-2xl mb-8">
          <div className="pix-gradient p-6 text-white text-center">
            <h2 className="text-lg font-black tracking-tight truncate px-2 uppercase">
              {config.merchant_name}
            </h2>
          </div>

          <div className="p-6 flex flex-col items-center">
            <div ref={qrRef} className="mb-6 p-4 bg-white rounded-[2rem] border-4 border-slate-50 shadow-inner flex flex-col items-center w-full max-w-[280px]">
              {/* Store Name above QR */}
            ...
            <div className="w-full space-y-4">
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  <div className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-4 pr-12 py-3.5 text-[11px] font-mono text-slate-600 truncate break-all">
                    {payload}
                  </div>
                  <button
                    onClick={handleCopy}
                    className={cn(
                      ...
                      "bg-white border border-slate-100 text-slate-400 hover:text-pix-purple"
                    )}
                  >
              ...
              <div className="grid grid-cols-3 gap-2 no-print">
                <button 
                  ...
                  className="flex flex-col items-center justify-center gap-1.5 py-3 bg-pix-purple/10 text-pix-purple border border-pix-purple/5 hover:bg-pix-purple hover:text-white rounded-2xl transition-all active:scale-95"
                >
                ...
                <button 
                  onClick={handleShare}
                  className="flex flex-col items-center justify-center gap-1.5 py-3 bg-pix-purple/10 text-pix-purple border border-pix-purple/5 hover:bg-pix-purple hover:text-white rounded-2xl shadow-lg shadow-pix-purple/5 transition-all active:scale-95"
                >
          ...
          <div className="bg-slate-50 p-4 border-t border-slate-100 no-print">
            <button
              onClick={() => navigate('/')}
              className="flex items-center justify-center gap-2 w-full text-slate-400 hover:text-pix-purple font-bold text-xs transition-colors py-2 active:scale-95"
            >
