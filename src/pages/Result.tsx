  ...
  if (error || !config) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center p-8 text-center bg-[var(--surface-1)]">
        ...
        <p className="text-[var(--text-secondary)] mb-8 text-[14px]">
        ...
        <div className="card shadow-[var(--shadow-lg)] border-[var(--color-pix-purple)]/20">
          ...
          <div className="p-8 flex flex-col items-center">
            ...
            <div className="text-center mb-8">
              <p className="text-[11px] font-extrabold text-[var(--text-tertiary)] uppercase tracking-[0.15em] mb-2">
                Total a Pagar
              </p>
              {amount > 0 ? (
            ...
            >
              <div className="bg-white rounded-[1.75rem] p-5 flex flex-col items-center">
                <div className="mb-4 flex flex-col items-center gap-1">
                  ...
                  <p className="text-[14px] font-bold text-[var(--text-primary)] truncate max-w-[220px]">
                ...
                <p className="mt-4 text-[11px] text-[var(--text-tertiary)] font-medium text-center leading-relaxed">
                  Escaneie este código no seu <br />
                  aplicativo bancário para pagar.
                </p>
              </div>
            </div>
                ...
                <div className="relative group">
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      copied
                        ? 'bg-[var(--color-pix-green)] text-white shadow-lg'
