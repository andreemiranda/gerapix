            ...
            {!showPasswordForm ? (
              <div className="space-y-4">
                ...
                <div className="relative flex items-center justify-center py-2">
                  ...
                  <span className="relative bg-white px-4 text-[11px] font-bold text-[var(--text-tertiary)] uppercase tracking-widest">
                    ou
                  </span>
                </div>
              ...
              >
                <div className="space-y-1.5">
                  <label htmlFor="email" className="label-sm ml-1">
                    E-mail Corporativo
                  </label>
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between items-center mb-1">
                    <label htmlFor="password" className="label-sm mb-0 ml-1">
                      Senha
                    </label>
                  </div>
                  <div className="relative">
